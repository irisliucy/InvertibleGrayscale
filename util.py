...
def write_result_file(save_path, total_time, train_data_dir=None, valid_data_dir=None, test_data_dir=None,
                    train_num=None, valid_num=None, test_num=None, num_parameters, batch_size, learning_rate, epoch_num):
    ...
    with open(save_path, 'w') as f:
        ...
        f.writelines('Training data dir: {}'.format(train_data_dir)) if train_data_dir
        f.writelines('Validation data dir: {}'.format(valid_data_dir)) if valid_data_dir
        f.writelines('Test data dir: {}'.format(test_data_dir)) if test_data_dir
        f.writelines('Num of training data: {}'.format(train_num)) if train_num
        f.writelines('Num of validation data: {}'.format(valid_num)) if valid_num
        f.writelines('Num of test data: {}'.format(test_num)) if test_num
        f.writelines('Num of total data: {}'.format(train_num + valid_num)) if train_num and valid_num
